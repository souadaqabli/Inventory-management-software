    ...
    return (
        <div className={`${hidden?"hidden":"grid grid-cols-12 items-center py-6 px-16 bg-white gap-4 relative"}`}>
            ...
            <div className='col-span-6'>
                ...
                <p>Businesses are moving towards online payments as they're easy, secure and fast. Try them for your bisiness today.</p>
            </div>
            {/* Button */}
            <div className='col-span-2'>
            <button className='py-2 px-8 uppercase text-sm bg-blue-500 text-white rounded-lg'>Enable</button>
            </div>
            {/* Close Button  */}
